...
class FeaturesDetailScreen extends StatefulWidget {
  const FeaturesDetailScreen(
      {super.key, required this.mobile, required this.featureName});

  final List<Mobile> mobile;
  final String featureName;

  @override
  State<FeaturesDetailScreen> createState() => _FeaturesDetailScreenState();
}

class _FeaturesDetailScreenState extends State<FeaturesDetailScreen> {
    ...
    Widget listView = SizedBox(
      ...
      child: ListView.builder(
        itemCount: widget.mobile
            .where((mobile) =>
                mobile.sim == widget.featureName.replaceAll(' ', ''))
            .toList()
            .length,
