...
class BatteryRangeMobileDetailsScreen extends StatefulWidget {
  const BatteryRangeMobileDetailsScreen({
    super.key,
  ...
  @override
  State<BatteryRangeMobileDetailsScreen> createState() =>
      _BatteryRangeMobileDetailsScreenState();
}

class _BatteryRangeMobileDetailsScreenState
    extends State<BatteryRangeMobileDetailsScreen> {
    ...
    Widget listView = SizedBox(
      ...
      child: ListView.builder(
        itemCount: widget.mobile
            .where((mobile) =>
                mobile.batteryPower >= widget.startingRange &&
                mobile.batteryPower <= widget.endingRange)
            .toList()
            .length,
